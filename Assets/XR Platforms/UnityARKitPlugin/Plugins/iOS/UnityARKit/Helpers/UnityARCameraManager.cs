...
public class UnityARCameraManager : MonoBehaviour {
	...
	void Update () {
        ...
        if (m_camera != null)
        {
			...
			m_camera.transform.parent.localPosition = UnityARMatrixOps.GetPosition(matrix);
			m_camera.transform.parent.localRotation = UnityARMatrixOps.GetRotation (matrix);
